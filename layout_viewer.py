...
if __name__ == '__main__':
    ...
    parser.add_argument('--img',
                        ...
                        default=r"D:\FPT\apring 2024\3dpanorama\HorizonNet\data\layoutnet_dataset\train\img\camera_00d10d86db1e435081a837ced388375f_office_24_frame_equirectangular_domain_.png")
    parser.add_argument('--layout',
                        required=False,
                        help='Txt file containing layout corners (cor_id)',
                        default=r'result_json\418687855_2096497004051286_1922402661784056484_n.jpg.json')
    ...
    im = cv2.imread(r"D:\FPT\apring 2024\3dpanorama\HorizonNet\data\layoutnet_dataset\train\img\camera_00d10d86db1e435081a837ced388375f_office_24_frame_equirectangular_domain_.png")
    cv2.imshow('im', im)
    cv2.waitKey(10*1000)
